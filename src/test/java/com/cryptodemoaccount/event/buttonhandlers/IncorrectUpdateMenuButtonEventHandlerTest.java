...
public class IncorrectUpdateMenuButtonEventHandlerTest {
    ...
    @InjectMocks
    private IncorrectUpdateMenuButtonEventHandler incorrectUpdateButtonHandler;
    ...
    public void handleForceCreateAsset() {
        ...
        ButtonEvent event = new ButtonEvent(this, Button.FORCE_CREATE_ASSET, chatId);

        incorrectUpdateButtonHandler.handleForceCreateAsset(event);
