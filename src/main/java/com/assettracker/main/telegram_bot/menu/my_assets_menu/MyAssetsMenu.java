...
import com.assettracker.main.telegram_bot.menu.manage_assets_menu.CancelToBagMenuButton;
...
public class MyAssetsMenu implements IMenu {
    ...
    private final List<IMyAssetsMenuButton> buttons;
    private final ManageAssetsButton manageAssetsButton;
    ...
    public InlineKeyboardMarkup combineButtons(List<? extends IButton> buttons) {
        return new InlineKeyboardMarkup(
                List.of(
                        new InlineKeyboardRow(manageAssetsButton.getButton()),
